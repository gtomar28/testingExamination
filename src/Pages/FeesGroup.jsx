      ...
      <div className="offcanvas offcanvas-end p-2" tabIndex="-1" id="deleteFeeGroup" aria-labelledby="deleteFeeGroupeLabel">
        ...
        <div className="offcanvas-body p-3">
          ...
          <div className="" style={{ zIndex: -1 }}>
            ...
            <p className='text-center greyText warningText pt-2'>This Action will be permanently delete<br />the Fee Group Data</p>
            <p className='text-center warningText p-2'><input className="form-check-input formdltcheck me-2" type="checkbox" checked={isChecked} id="flexCheckChecked" onChange={(e) => setIsChecked(e.target.checked)} />I Agree to delete the Fee Group Data</p>

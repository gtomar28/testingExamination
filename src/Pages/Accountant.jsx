...
const Accountant = () => {
  ...
  const [AccountAllData, setAccountAllData] = useState([])
          ...
          <div className="breadCrum ms-2">
            <nav style={{ '--bs-breadcrumb-divider': "'>'" }} aria-label="breadcrumb">
              <ol className="breadcrumb ms-2">
                ...
                <li className="breadcrumb-item breadcrum-li heading-14" ><Link href="#">Accountant</Link></li>
              </ol>
            </nav>
          </div>
          ...
          <div className='d-flex g-1 for-media-query'>
            ...
            <div className='me-2 search-responsive'>
              <div className="input-group mb-3 search-responsive">
                <input type="text" className="form-control form-focus font-color" style={{ height: '34px' }} onChange={(e) => setSearchKkey(e.target.value)} placeholder="Search" aria-label="Recipient's username" aria-describedby="basic-addon2" />
            ...
            <Link type="button" className="btn btn-success heading-16 my-own-button me-3"  onClick={(e)=> localoStorage("0")} to={`/mainuserform/${'0'}`}>+ ADD Accountant</Link>

          </div>

        </div>
        <h5 className='ms-3 mb-2 margin-minus22 heading-16 heading-responsive' style={{ marginTop: '-22px' }}>Accountant List</h5>
            ...
            <>
              <div className="offcanvas offcanvas-end" tabindex="-1" id="staticBackdrop" aria-labelledby="offcanvasRightLabel" ref={offcanvasRef}>
                <div className="offcanvas-header">
                  ...
                  <h5 className="offcanvas-title heading-16" id="offcanvasRightLabel">Edit Account</h5>
                </div>
                ...
                <div class="offcanvas-body">
                  ...
                  <div>
                    ...
                    <div className="input-group mb-3 cont-drop-btn">
                      ...
                      <input type="text" className="form-control form-focus" onChange={(e) => handleContact(e.target.value)} value={TeacherContact} aria-label="Text input with dropdown button" />
                    </div>
                  </div>

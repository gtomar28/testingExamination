...
import { TeacherHolidayPostApi } from '../Utils/Apis'
import { TeacherHolidayGetAllApi } from '../Utils/Apis'
import { TeacherHolidayDeleteApi } from '../Utils/Apis'
import { TeacherHolidayCSV } from '../Utils/Apis'
import { TeacherHolidayPDF } from '../Utils/Apis'
import { TeacherHolidayGetByIdApi } from '../Utils/Apis'
import { TeacherHolidayPutApi } from '../Utils/Apis'
      ...
      <div className="container-fluid main-body p-3">
        ...
        <div className='d-flex justify-content-between for-dislay-direction'>
          ...
          <div className='d-flex g-1 for-media-query'>
            ...
            <div className='d-flex addbtn-response'>
        ...
        <h5 className='ms-3 mb-2 margin-minus22 heading-16 heading-responsive' style={{ marginTop: '-22px' }}>Holiday Details</h5>

            ...
            <div className="offcanvas offcanvas-end p-2" data-bs-backdrop="static" tabIndex="-1" id="Delete_staticBackdrop" aria-labelledby="staticBackdropLabel">
                ...
                <div className="offcanvas-body p-0">
                    ...
                    <div className="" style={{ zIndex: -1 }}>
                        ...
                        <p className='text-center warningText p-2'><input className="form-check-input formdltcheck me-2" type="checkbox" value="" id="flexCheckChecked" onChange={(e) => setIsChecked(e.target.checked)} />I Agree to delete the Session Manager Data</p>
                        <p className='text-center p-3'>

      ...
      <div className="offcanvas offcanvas-end p-2" tabIndex="-1" id="deleteFeeType" aria-labelledby="deleteFeeTypeLabel">
        ...
        <div className="offcanvas-body p-3">
          ...
          <div className="" style={{ zIndex: -1 }}>
            ...
            <p className='text-center greyText warningText pt-2'>This Action will be permanently delete<br />the Fee Type Data</p>
            <p className='text-center warningText p-2'><input className="form-check-input formdltcheck me-2" type="checkbox" value="" id="flexCheckChecked" onChange={(e) => setIsChecked(e.target.checked)} />I Agree to delete the Fee Type Data</p>

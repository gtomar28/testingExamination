...
import { EventPostApi } from '../Utils/Apis'
import { EventGetAllApi } from '../Utils/Apis'
import { EventDeleteApi } from '../Utils/Apis'
import { EventGetByIdApi } from '../Utils/Apis'
import { EventPutApi } from '../Utils/Apis'
import { EventCSV } from '../Utils/Apis'
          ...
          <div className='d-flex g-1 for-media-query'>
            ...
            <div className='me-2 search-responsive'>
              <div className="input-group mb-3 search-responsive">
                ...
                <span className="input-group-text button-bg-color button-color heading-14 font-color " style={{ cursor: 'pointer', height: "34px" }} onClick={''} id="basic-addon2">Search</span>
                {/* MyEventGetAllApi */}
              </div>
            </div>

...
import { ClassPostApi } from '../Utils/Apis'
...
const ClassList = () => {
  ...
  const FuncValidation = () => {
    let isValid = true;
    // number 
    if (!classno || classno === "" || !/^[0-9]+$/.test(classno)) {
          ...
          <div className="breadCrum ms-2">
            <nav style={{ '--bs-breadcrumb-divider': "'>'" }} aria-label="breadcrumb">
              <ol className="breadcrumb ms-2">
                ...
                <li className="breadcrumb-item breadcrum-li heading-14" ><Link href="#" onClick={UpdatClassGetApi}>Class List</Link></li>
              </ol>
            </nav>
          </div>
          <div className='d-flex g-1 for-media-query'>
            <div className='me-2 search-responsive'>
              <div className="input-group mb-3 ">
                ...
                <span className="input-group-text button-bg-color button-color heading-14 font-color " style={{ cursor: 'pointer', height: "34px" }} id="basic-addon2" onClick={UpdatClassGetApi}>Search</span>
              </div>
            </div>
            <Link type="button" className="btn btn-success heading-16 my-own-button me-3" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop" aria-controls="staticBackdrop" to={''}>+ ADD Class</Link>
          </div>
            ...
            <>
              <div className="offcanvas-end offcanvas" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop" aria-labelledby="staticBackdropLabel" ref={offcanvasRef}>
                <div className="offcanvas-header">
                  ...
                  <h5 className="offcanvas-title heading-16" id="offcanvasRightLabel">Add Class</h5>
                </div>
                ...
                <div class="offcanvas-body">
                  <div className="input " >
                    <div className="mb-3 " style={{ marginTop: '-18px' }}>
                      ...
                      <input type="text" className="form-control form-focus   label-color heading-14" onChange={(e) => handleName(e.target.value)} style={{ marginTop: '-4px' }} id="exampleFormControlInput1" placeholder="Add Class No" />
                    </div>
                    <div className='pt-1'>
                      {isValidNameRequired && (
                        <p className='ms-1' style={{ color: 'red', fontSize: '14px', marginTop: '-18px' }}>
                          Integer required up to 12
                        </p>
                      )}
                    </div>
                    <div className='my-button11 '>
                      <button type="button" className="btn btn-outline-success my-button112233" onClick={(e) => SubcPutDataApi()}>Add Class</button>
            ...
            <>
              <div className="offcanvas offcanvas-end " tabindex="-1" id="staticBackdrop12" aria-labelledby="offcanvasRightLabel" ref={offcanvasRef22}>
                <div className="offcanvas-header">
                  ...
                  <h5 className="offcanvas-title heading-16" id="offcanvasRightLabel">Edit Class</h5>
                </div>
                ...
                <div class="offcanvas-body pt-0">
                  <div className="inputs">
                    ...
                    <div className="mb-3 ">
                      ...
                      <input type="text" className="form-control form-control-md form-focus " value={classno} onChange={(e) => handleName(e.target.value)} style={{ marginTop: '-4px' }} id="exampleFormControlInput1" placeholder="" />
                    </div>
                    <div className='pt-1'>
                      {isValidNameRequired && (
                        <p className='ms-1' style={{ color: 'red', fontSize: '14px', marginTop: '-18px' }}>
